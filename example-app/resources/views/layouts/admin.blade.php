...
<head>
  ...
  <title>Perdidos e Achados | Dashboard</title>
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="/assets/logoPA.png" alt="Logo" height="60" width="60">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="/dashboard" class="brand-link ml-1">
      <img src="/assets/logoPA.png" alt="Logo" class="brand-image" style="opacity: .9">
      <span class="brand-text font-weight-light">Perdidos e Achados</span>
    </a>
          ...
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ route('objetos.create') }}" class="nav-link">
                            <i class="far fa-file nav-icon"></i>
                            <p>Novo objeto</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('objetos') }}" class="nav-link">
            ...
            <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ route('turmas.create') }}" class="nav-link">
                            <i class="far fa-file nav-icon"></i>
                            <p>Nova Turma</p>
                        </a>
                    </li>
